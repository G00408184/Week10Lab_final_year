...
class ProductServiceTest {
    ...
    {
        Product product = new Product(1L, "Laptop", "Expensive", 1500);
        IllegalArgumentException iea = assertThrows(IllegalArgumentException.class, ()-> productService.saveProduct(product));
        Product expectedProduct = productService.saveProduct(product);
        assertEquals("price cannot be negative", iea.getMessage());
    }
}
